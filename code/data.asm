...
; + 2 контейнера (обычный + сдвинутый на 4 бита)
; + 2 контейнера (обычный + сдвинутый на 4 бита) v2
; + 2 контейнера (обычный + 4 бита стены справа, сдвинутый на 4 бита + 4 бита стены слева)
; + 2 контейнера (обычный + 4 бита стены справа, сдвинутый на 4 бита + 4 бита стены слева) v2
container_sprite_buffer:
		block	2*16*8
...
clear_data:				block	4 * MAX_CRATES	
; + 2 байта - адрес экрана; 2 байта адрес спрайта
draw_data:				block	4 * MAX_CRATES	

draw_containers_data:
					block 4 * MAX_CRATES
